...
def homepage(request):
	fp=open('/home/delhivery/Test/mysite/demo/templates/homepage.html')
	t=Template(fp.read())
	fp.close()
...
def login(request):
	fp=open('/home/delhivery/Test/mysite/demo/templates/login.html')
	t=Template(fp.read())
	fp.close()
	html=t.render(Context())
	return HttpResponse(html)
...
def login_view(request):
	...
	if a.password == request.GET['password']:
		...
		return render(request,'/home/delhivery/Test/mysite/demo/templates/nsession.html/',{"author":a})
	else:
		return render(request,'/home/delhivery/Test/mysite/demo/templates/incorrect_login.html/')


def signup(request):
	fp = open('/home/delhivery/Test/mysite/demo/templates/signup.html')
	t=Template(fp.read())
	fp.close()
	html=t.render(Context())
	return HttpResponse(html)
...
def new_session(request):
	...
	return render(request,'/home/delhivery/Test/mysite/demo/templates/nsession.html',{"author":q})
...
def logout(request):
	try:
		...
		pass
	return render(request,'/home/delhivery/Test/mysite/demo/templates/logout.html/')
...
def add_view(request):
	...
	return render(request,'/home/delhivery/Test/mysite/demo/templates/user1.html',{"author":q})
...
def new_article(request):
	...
	fp = open('/home/delhivery/Test/mysite/demo/templates/add_article.html')
	t = Template(fp.read())
	fp.close()
...
def view_article(request):
	...
	if aid == None:
		...
		return render(request,'/home/delhivery/Test/mysite/demo/templates/view_title.html',{"article_list":article})
	else:
		all_article = Article.objects.all()
		article = Article.objects.filter(author_name=a_name)
		return render(request,'/home/delhivery/Test/mysite/demo/templates/view_title_aut.html',{'author_name':a_name,'article_list':article})
...
def suces(request):
	...
	at.save()
	fp = open('/home/delhivery/Test/mysite/demo/templates/succes.html')
	t = Template(fp.read)
	fp.close()
